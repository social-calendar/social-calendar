					...
					<div class="row-fluid">
						...
						<div class="span12">
							...
							<form action="#" id="addmessage" method="post">
									...
									<br>
									<button class="am-btn am-btn-primary am-btn-xs" id="leavemessage" type="button">
							...
							<table id="sample-table-1" class="table table-striped table-bordered table-hover">
								...
								<c:forEach items="${studentMessageList}"  var="message" varStatus="sta" >
									<tr>
										...
										<td><button class="am-btn am-btn-primary am-btn-xs" onclick="if(window.confirm('确认删除这条留言？')==true)location.href='<%=request.getContextPath() %>/manager/deletemessage?studentid=${student.id}&messageid=${message.id}'"><i class="icon-remove"></i>删除留言</button></td>
									</tr>
								</c:forEach>
								</tbody>
							</table>

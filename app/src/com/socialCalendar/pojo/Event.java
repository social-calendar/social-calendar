...
public class Event {
	...
	public String toString() {
		return "Event [id=" + id + ", title=" + title + ", startDate="
				...
				+ promoterID + ", alarm=" + alarm + ", promoter=" + promoter
	...
	public Event(Integer id, String title, Timestamp startDate,
			...
			String place, Integer state, Integer promoterID, Integer alarm,
			User promoter, List<EventDetail> eventDetails) {
		super();
		this.id = id;
		this.title = title;
		this.startDate = startDate;
